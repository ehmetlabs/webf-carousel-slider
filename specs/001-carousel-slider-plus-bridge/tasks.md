...
- [ ] T017 [US2] Audit and simplify enum conversion in `native_uis/webf_carousel_slider/lib/src/utils/enum_converter.dart`
- [ ] T018 [US2] Audit and simplify type conversion in `native_uis/webf_carousel_slider/lib/src/utils/type_converter.dart`
- [ ] T019 [US2] Audit and simplify item parsing in `native_uis/webf_carousel_slider/lib/src/utils/carousel_items_parser.dart`
...
- [ ] T020 [US3] Finalize coverage checklist with status columns in `specs/001-carousel-slider-plus-bridge/api-coverage.md`
- [ ] T021 [US3] Add example call snippets per API in `specs/001-carousel-slider-plus-bridge/api-coverage.md`
